...
- **downloads:**
  - [**`sqldeveloper-package_0.5.3_all.deb`**](https://github.com/lazarusllong/sqldeveloper-package/releases/download/0.5.3/sqldeveloper-package_0.5.3_all.deb) (_binary package_)
  - [`sqldeveloper-package_0.5.3.dsc`](https://github.com/lazarusllong/sqldeveloper-package/releases/download/0.5.3/sqldeveloper-package_0.5.3.dsc) (_source description file_)
  - [`sqldeveloper-package_0.5.3.tar.xz`](https://github.com/lazarusllong/sqldeveloper-package/releases/download/0.5.3/sqldeveloper-package_0.5.3.tar.xz) (_source code archive_)
  - [`v0.5.2_v0.5.3.debdiff`](https://github.com/lazarusllong/sqldeveloper-package/releases/download/0.5.3/v0.5.2_v0.5.3.debdiff) (_Debian diff from previous version_)
